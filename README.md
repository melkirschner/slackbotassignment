...
melhubotapp is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running melhubotapp Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start melhubotapp locally by running:
...
Then you can interact with melhubotapp by typing `melhubotapp help`.

    melhubotapp> melhubotapp help
    melhubotapp animate me <query> - The same thing as `image me`, except adds [snip]
    melhubotapp help - Displays all of the help commands that melhubotapp knows about.
    ...
